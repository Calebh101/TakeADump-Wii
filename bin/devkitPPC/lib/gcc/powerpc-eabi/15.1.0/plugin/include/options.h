...
enum opt_code
{
  ...
  OPT__param_vect_force_slp_ = 365,          /* --param=vect-force-slp= */
  OPT__param_vect_induction_float_ = 366,    /* --param=vect-induction-float= */
  OPT__param_vect_inner_loop_cost_factor_ = 367,/* --param=vect-inner-loop-cost-factor= */
  OPT__param_vect_max_layout_candidates_ = 368,/* --param=vect-max-layout-candidates= */
  OPT__param_vect_max_peeling_for_alignment_ = 369,/* --param=vect-max-peeling-for-alignment= */
  OPT__param_vect_max_version_for_alias_checks_ = 370,/* --param=vect-max-version-for-alias-checks= */
  OPT__param_vect_max_version_for_alignment_checks_ = 371,/* --param=vect-max-version-for-alignment-checks= */
  OPT__param_vect_partial_vector_usage_ = 372,/* --param=vect-partial-vector-usage= */
  OPT__param_vrp_block_limit_ = 373,         /* --param=vrp-block-limit= */
  OPT__param_vrp_sparse_threshold_ = 374,    /* --param=vrp-sparse-threshold= */
  OPT__param_vrp_switch_limit_ = 375,        /* --param=vrp-switch-limit= */
  OPT__param_vrp_vector_threshold_ = 376,    /* --param=vrp-vector-threshold= */
  /* OPT__pass_exit_codes = 377, */          /* --pass-exit-codes */
  /* OPT__pedantic = 378, */                 /* --pedantic */
  /* OPT__pedantic_errors = 379, */          /* --pedantic-errors */
  /* OPT__pie = 380, */                      /* --pie */
  /* OPT__pipe = 381, */                     /* --pipe */
  /* OPT__prefix = 382, */                   /* --prefix */
  /* OPT__prefix_ = 383, */                  /* --prefix= */
  /* OPT__preprocess = 384, */               /* --preprocess */
  /* OPT__print_file_name = 385, */          /* --print-file-name */
  /* OPT__print_file_name_ = 386, */         /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 387, */   /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 388, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 389, */    /* --print-multi-directory */
  /* OPT__print_multi_lib = 390, */          /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 391, */ /* --print-multi-os-directory */
  /* OPT__print_multiarch = 392, */          /* --print-multiarch */
  /* OPT__print_prog_name = 393, */          /* --print-prog-name */
  /* OPT__print_prog_name_ = 394, */         /* --print-prog-name= */
  /* OPT__print_search_dirs = 395, */        /* --print-search-dirs */
  /* OPT__print_sysroot = 396, */            /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 397, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 398, */                  /* --profile */
  /* OPT__save_temps = 399, */               /* --save-temps */
  /* OPT__shared = 400, */                   /* --shared */
  /* OPT__specs = 401, */                    /* --specs */
  /* OPT__specs_ = 402, */                   /* --specs= */
  /* OPT__static = 403, */                   /* --static */
  /* OPT__static_pie = 404, */               /* --static-pie */
  /* OPT__symbolic = 405, */                 /* --symbolic */
  /* OPT__sysroot = 406, */                  /* --sysroot */
  OPT__sysroot_ = 407,                       /* --sysroot= */
  OPT__target_help = 408,                    /* --target-help */
  /* OPT__time = 409, */                     /* --time */
  /* OPT__trace_includes = 410, */           /* --trace-includes */
  /* OPT__traditional = 411, */              /* --traditional */
  /* OPT__traditional_cpp = 412, */          /* --traditional-cpp */
  /* OPT__trigraphs = 413, */                /* --trigraphs */
  /* OPT__undefine_macro = 414, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 415, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 416, */        /* --user-dependencies */
  /* OPT__verbose = 417, */                  /* --verbose */
  OPT__version = 418,                        /* --version */
  /* OPT__write_dependencies = 419, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 420, */  /* --write-user-dependencies */
  OPT_A = 421,                               /* -A */
  OPT_B = 422,                               /* -B */
  OPT_C = 423,                               /* -C */
  OPT_CC = 424,                              /* -CC */
  ...
  OPT_MQ = 442,                              /* -MQ */
  OPT_MT = 443,                              /* -MT */
  OPT_Mmodules = 444,                        /* -Mmodules */
  OPT_Mno_modules = 445,                     /* -Mno-modules */
  OPT_N = 446,                               /* -N */
  OPT_O = 447,                               /* -O */
  OPT_Ofast = 448,                           /* -Ofast */
  OPT_Og = 449,                              /* -Og */
  ...
  OPT_Tbss_ = 460,                           /* -Tbss= */
  OPT_Tdata = 461,                           /* -Tdata */
  OPT_Tdata_ = 462,                          /* -Tdata= */
  OPT_Ttext = 463,                           /* -Ttext */
  OPT_Ttext_ = 464,                          /* -Ttext= */
  OPT_U = 465,                               /* -U */
  /* OPT_W = 466, */                         /* -W */
  OPT_WNSObject_attribute = 467,             /* -WNSObject-attribute */
  OPT_Wa_ = 468,                             /* -Wa, */
  OPT_Wabi = 469,                            /* -Wabi */
  OPT_Wabi_tag = 470,                        /* -Wabi-tag */
  OPT_Wabi_ = 471,                           /* -Wabi= */
  OPT_Wabsolute_value = 472,                 /* -Wabsolute-value */
  OPT_Waddress = 473,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 474,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 475,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 476,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 477,                       /* -Waliasing */
  OPT_Walign_commons = 478,                  /* -Walign-commons */
  /* OPT_Waligned_new = 479, */              /* -Waligned-new */
  OPT_Waligned_new_ = 480,                   /* -Waligned-new= */
  OPT_Wall = 481,                            /* -Wall */
  OPT_Walloc_size = 482,                     /* -Walloc-size */
  OPT_Walloc_size_larger_than_ = 483,        /* -Walloc-size-larger-than= */
  OPT_Walloc_zero = 484,                     /* -Walloc-zero */
  OPT_Walloca = 485,                         /* -Walloca */
  OPT_Walloca_larger_than_ = 486,            /* -Walloca-larger-than= */
  OPT_Wampersand = 487,                      /* -Wampersand */
  OPT_Wanalyzer_allocation_size = 488,       /* -Wanalyzer-allocation-size */
  OPT_Wanalyzer_deref_before_check = 489,    /* -Wanalyzer-deref-before-check */
  OPT_Wanalyzer_double_fclose = 490,         /* -Wanalyzer-double-fclose */
  OPT_Wanalyzer_double_free = 491,           /* -Wanalyzer-double-free */
  OPT_Wanalyzer_exposure_through_output_file = 492,/* -Wanalyzer-exposure-through-output-file */
  OPT_Wanalyzer_exposure_through_uninit_copy = 493,/* -Wanalyzer-exposure-through-uninit-copy */
  OPT_Wanalyzer_fd_access_mode_mismatch = 494,/* -Wanalyzer-fd-access-mode-mismatch */
  OPT_Wanalyzer_fd_double_close = 495,       /* -Wanalyzer-fd-double-close */
  OPT_Wanalyzer_fd_leak = 496,               /* -Wanalyzer-fd-leak */
  OPT_Wanalyzer_fd_phase_mismatch = 497,     /* -Wanalyzer-fd-phase-mismatch */
  OPT_Wanalyzer_fd_type_mismatch = 498,      /* -Wanalyzer-fd-type-mismatch */
  OPT_Wanalyzer_fd_use_after_close = 499,    /* -Wanalyzer-fd-use-after-close */
  OPT_Wanalyzer_fd_use_without_check = 500,  /* -Wanalyzer-fd-use-without-check */
  OPT_Wanalyzer_file_leak = 501,             /* -Wanalyzer-file-leak */
  OPT_Wanalyzer_free_of_non_heap = 502,      /* -Wanalyzer-free-of-non-heap */
  OPT_Wanalyzer_imprecise_fp_arithmetic = 503,/* -Wanalyzer-imprecise-fp-arithmetic */
  OPT_Wanalyzer_infinite_loop = 504,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 505,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 506,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 507,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 508,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 509,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 510,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 511,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 512,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 513,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 514,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 515,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 516,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 517,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 518,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 519,    /* -Wanalyzer-symbol-too-complex */
  OPT_Wanalyzer_tainted_allocation_size = 520,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 521,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 522,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 523,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 524,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 525,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 526,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_ptrdiff = 527,/* -Wanalyzer-undefined-behavior-ptrdiff */
  OPT_Wanalyzer_undefined_behavior_strtok = 528,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 529,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 530,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 531,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 532,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 533,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 534,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 535,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 536,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 537,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 538,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 539,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 540,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 541, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 542,                  /* -Warray-bounds= */
  OPT_Warray_compare = 543,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 544, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 545,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 546,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 547,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 548, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 549,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 550,              /* -Wattribute-warning */
  OPT_Wattributes = 551,                     /* -Wattributes */
  OPT_Wattributes_ = 552,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 553,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 554, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 555,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 556,                   /* -Wbool-compare */
  OPT_Wbool_operation = 557,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 558,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 559,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 560,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 561, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 562,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 563,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 564,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 565,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 566,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 567,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 568, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 569,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 570,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 571,               /* -Wc++23-extensions */
  ...
  OPT_Wextra = 657,                          /* -Wextra */
  OPT_Wextra_semi = 658,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 659,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 660,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 661,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 662,                    /* -Wfloat-equal */
  /* OPT_Wformat = 663, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 664,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 665,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 666,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 667,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 668, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 669,               /* -Wformat-overflow= */
  OPT_Wformat_security = 670,                /* -Wformat-security */
  OPT_Wformat_signedness = 671,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 672, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 673,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 674,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 675,             /* -Wformat-zero-length */
  OPT_Wformat_ = 676,                        /* -Wformat= */
  OPT_Wframe_address = 677,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 678,             /* -Wframe-larger-than= */
  OPT_Wfree_labels = 679,                    /* -Wfree-labels */
  OPT_Wfree_nonheap_object = 680,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 681,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 682,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 683,                  /* -Wglobal-module */
  OPT_Whardened = 684,                       /* -Whardened */
  OPT_Wheader_guard = 685,                   /* -Wheader-guard */
  /* OPT_Whsa = 686, */                      /* -Whsa */
  OPT_Wif_not_aligned = 687,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 688,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 689,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 690,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 691, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 692,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 693,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 694,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 695,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 696,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 697, */                   /* -Wimport */
  OPT_Winaccessible_base = 698,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 699,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 700,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 701,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 702,             /* -Winit-list-lifetime */
  OPT_Winit_self = 703,                      /* -Winit-self */
  OPT_Winline = 704,                         /* -Winline */
  OPT_Wint_conversion = 705,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 706,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 707,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 708,               /* -Winteger-division */
  OPT_Winterference_size = 709,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 710,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 711,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 712,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 713,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 714,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 715,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 716,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 717,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 718,               /* -Wjump-misses-init */
  OPT_Wl_ = 719,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 720, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 721,                   /* -Wlarger-than= */
  OPT_Wleading_whitespace_ = 722,            /* -Wleading-whitespace= */
  OPT_Wline_truncation = 723,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 724,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 725,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 726,                     /* -Wlogical-op */
  OPT_Wlong_long = 727,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 728,              /* -Wlto-type-mismatch */
  OPT_Wmain = 729,                           /* -Wmain */
  OPT_Wmaybe_musttail_local_addr = 730,      /* -Wmaybe-musttail-local-addr */
  OPT_Wmaybe_uninitialized = 731,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 732,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 733,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 734,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 735,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 736,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 737,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 738,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 739,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 740,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 741,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 742,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 743, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 744,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 745, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_name = 746,         /* -Wmissing-parameter-name */
  OPT_Wmissing_parameter_type = 747,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 748,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 749,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 750,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 751,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 752,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 753,                        /* -Wmudflap */
  OPT_Wmultichar = 754,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 755,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 756,          /* -Wmultistatement-macros */
  OPT_Wmusttail_local_addr = 757,            /* -Wmusttail-local-addr */
  OPT_Wnamespaces = 758,                     /* -Wnamespaces */
  OPT_Wnarrowing = 759,                      /* -Wnarrowing */
  OPT_Wnested_externs = 760,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 761, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 762, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 763, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 764, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 765, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 766, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 767,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 768,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 769,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 770,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 771,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 772,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 773, */               /* -Wnormalized */
  OPT_Wnormalized_ = 774,                    /* -Wnormalized= */
  OPT_Wnrvo = 775,                           /* -Wnrvo */
  OPT_Wnull_dereference = 776,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 777,                /* -Wobjc-root-class */
  OPT_Wodr = 778,                            /* -Wodr */
  OPT_Wold_style_cast = 779,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 780,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 781,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 782,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 783,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 784,                    /* -Wopenmp-simd */
  OPT_Woverflow = 785,                       /* -Woverflow */
  OPT_Woverlength_strings = 786,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 787, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 788,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 789,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 790,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 791,            /* -Woverwrite-recursive */
  OPT_Wp_ = 792,                             /* -Wp, */
  OPT_Wpacked = 793,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 794,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 795,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 796,                         /* -Wpadded */
  OPT_Wparentheses = 797,                    /* -Wparentheses */
  OPT_Wpedantic = 798,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 799,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 800,           /* -Wpedantic-param-names */
  OPT_Wpessimizing_move = 801,               /* -Wpessimizing-move */
  /* OPT_Wplacement_new = 802, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 803,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 804,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 805,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 806,                /* -Wpointer-compare */
  OPT_Wpointer_sign = 807,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 808,            /* -Wpointer-to-int-cast */
  OPT_Wpragma_once_outside_header = 809,     /* -Wpragma-once-outside-header */
  OPT_Wpragmas = 810,                        /* -Wpragmas */
  OPT_Wprio_ctor_dtor = 811,                 /* -Wprio-ctor-dtor */
  OPT_Wproperty_assign_default = 812,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 813,                       /* -Wprotocol */
  OPT_Wpsabi = 814,                          /* -Wpsabi */
  OPT_Wrange_loop_construct = 815,           /* -Wrange-loop-construct */
  OPT_Wreal_q_constant = 816,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 817,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 818,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 819,                /* -Wredundant-decls */
  OPT_Wredundant_move = 820,                 /* -Wredundant-move */
  OPT_Wredundant_tags = 821,                 /* -Wredundant-tags */
  OPT_Wregister = 822,                       /* -Wregister */
  OPT_Wreorder = 823,                        /* -Wreorder */
  OPT_Wrestrict = 824,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 825,              /* -Wreturn-local-addr */
  OPT_Wreturn_mismatch = 826,                /* -Wreturn-mismatch */
  OPT_Wreturn_type = 827,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 828,           /* -Wscalar-storage-order */
  OPT_Wselector = 829,                       /* -Wselector */
  OPT_Wself_move = 830,                      /* -Wself-move */
  OPT_Wsequence_point = 831,                 /* -Wsequence-point */
  OPT_Wshadow = 832,                         /* -Wshadow */
  /* OPT_Wshadow_compatible_local = 833, */  /* -Wshadow-compatible-local */
  OPT_Wshadow_ivar = 834,                    /* -Wshadow-ivar */
  /* OPT_Wshadow_local = 835, */             /* -Wshadow-local */
  OPT_Wshadow_compatible_local = 836,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 837, */            /* -Wshadow=global */
  OPT_Wshadow_local = 838,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 839,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 840,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 841,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 842, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 843,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 844,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 845,                /* -Wsign-conversion */
  OPT_Wsign_promo = 846,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 847,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 848,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_array_div = 849,               /* -Wsizeof-array-div */
  OPT_Wsizeof_pointer_div = 850,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 851,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspeculative = 852,                    /* -Wspeculative */
  OPT_Wstack_protector = 853,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 854,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 855,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 856,               /* -Wstrict-aliasing= */
  OPT_Wstrict_flex_arrays = 857,             /* -Wstrict-flex-arrays */
  OPT_Wstrict_null_sentinel = 858,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 859,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 860,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 861,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 862,          /* -Wstrict-selector-match */
  OPT_Wstring_compare = 863,                 /* -Wstring-compare */
  /* OPT_Wstringop_overflow = 864, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 865,             /* -Wstringop-overflow= */
  OPT_Wstringop_overread = 866,              /* -Wstringop-overread */
  OPT_Wstringop_truncation = 867,            /* -Wstringop-truncation */
  OPT_Wstyle = 868,                          /* -Wstyle */
  OPT_Wsubobject_linkage = 869,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_cold = 870,         /* -Wsuggest-attribute=cold */
  OPT_Wsuggest_attribute_const = 871,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 872,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_malloc = 873,       /* -Wsuggest-attribute=malloc */
  OPT_Wsuggest_attribute_noreturn = 874,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 875,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_attribute_returns_nonnull = 876,/* -Wsuggest-attribute=returns_nonnull */
  OPT_Wsuggest_final_methods = 877,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 878,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 879,               /* -Wsuggest-override */
  OPT_Wsurprising = 880,                     /* -Wsurprising */
  OPT_Wswitch = 881,                         /* -Wswitch */
  OPT_Wswitch_bool = 882,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 883,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 884,                    /* -Wswitch-enum */
  OPT_Wswitch_outside_range = 885,           /* -Wswitch-outside-range */
  OPT_Wswitch_unreachable = 886,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 887,                      /* -Wsync-nand */
  OPT_Wsynth = 888,                          /* -Wsynth */
  OPT_Wsystem_headers = 889,                 /* -Wsystem-headers */
  OPT_Wtabs = 890,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 891,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 892,           /* -Wtautological-compare */
  OPT_Wtemplate_body = 893,                  /* -Wtemplate-body */
  OPT_Wtemplate_id_cdtor = 894,              /* -Wtemplate-id-cdtor */
  OPT_Wtemplate_names_tu_local = 895,        /* -Wtemplate-names-tu-local */
  OPT_Wtemplates = 896,                      /* -Wtemplates */
  OPT_Wterminate = 897,                      /* -Wterminate */
  OPT_Wtraditional = 898,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 899,         /* -Wtraditional-conversion */
  /* OPT_Wtrailing_whitespace = 900, */      /* -Wtrailing-whitespace */
  OPT_Wtrailing_whitespace_ = 901,           /* -Wtrailing-whitespace= */
  OPT_Wtrampolines = 902,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 903,                      /* -Wtrigraphs */
  OPT_Wtrivial_auto_var_init = 904,          /* -Wtrivial-auto-var-init */
  OPT_Wtsan = 905,                           /* -Wtsan */
  OPT_Wtype_limits = 906,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 907,            /* -Wundeclared-selector */
  OPT_Wundef = 908,                          /* -Wundef */
  OPT_Wundefined_do_loop = 909,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 910,                      /* -Wunderflow */
  OPT_Wunicode = 911,                        /* -Wunicode */
  OPT_Wuninit_variable_checking = 912,       /* -Wuninit-variable-checking */
  OPT_Wuninit_variable_checking_ = 913,      /* -Wuninit-variable-checking= */
  OPT_Wuninitialized = 914,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 915,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 916, */         /* -Wunreachable-code */
  /* OPT_Wunsafe_loop_optimizations = 917, *//* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 918,     /* -Wunsuffixed-float-constants */
  OPT_Wunterminated_string_initialization = 919,/* -Wunterminated-string-initialization */
  OPT_Wunused = 920,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 921,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 922,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 923, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 924,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 925,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 926,                /* -Wunused-function */
  OPT_Wunused_label = 927,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 928,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 929,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 930,               /* -Wunused-parameter */
  OPT_Wunused_result = 931,                  /* -Wunused-result */
  OPT_Wunused_value = 932,                   /* -Wunused-value */
  OPT_Wunused_variable = 933,                /* -Wunused-variable */
  OPT_Wuse_after_free = 934,                 /* -Wuse-after-free */
  OPT_Wuse_after_free_ = 935,                /* -Wuse-after-free= */
  OPT_Wuse_without_only = 936,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 937,                   /* -Wuseless-cast */
  OPT_Wvarargs = 938,                        /* -Wvarargs */
  OPT_Wvariadic_macros = 939,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 940,   /* -Wvector-operation-performance */
  OPT_Wverbose_unbounded = 941,              /* -Wverbose-unbounded */
  OPT_Wvexing_parse = 942,                   /* -Wvexing-parse */
  OPT_Wvirtual_inheritance = 943,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 944,            /* -Wvirtual-move-assign */
  OPT_Wvla = 945,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 946,               /* -Wvla-larger-than= */
  OPT_Wvla_parameter = 947,                  /* -Wvla-parameter */
  OPT_Wvolatile = 948,                       /* -Wvolatile */
  OPT_Wvolatile_register_var = 949,          /* -Wvolatile-register-var */
  OPT_Wwrite_strings = 950,                  /* -Wwrite-strings */
  OPT_Wxor_used_as_pow = 951,                /* -Wxor-used-as-pow */
  OPT_Wzero_as_null_pointer_constant = 952,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzero_length_bounds = 953,             /* -Wzero-length-bounds */
  OPT_Wzerotrip = 954,                       /* -Wzerotrip */
  OPT_X = 955,                               /* -X */
  OPT_Xassembler = 956,                      /* -Xassembler */
  OPT_Xf = 957,                              /* -Xf */
  OPT_Xlinker = 958,                         /* -Xlinker */
  OPT_Xpreprocessor = 959,                   /* -Xpreprocessor */
  OPT_Z = 960,                               /* -Z */
  OPT_ansi = 961,                            /* -ansi */
  OPT_aux_info = 962,                        /* -aux-info */
  /* OPT_aux_info_ = 963, */                 /* -aux-info= */
  OPT_c = 964,                               /* -c */
  OPT_callgraph = 965,                       /* -callgraph */
  OPT_copyext = 966,                         /* -copyext */
  OPT_coverage = 967,                        /* -coverage */
  OPT_cpp = 968,                             /* -cpp */
  OPT_cpp_ = 969,                            /* -cpp= */
  OPT_d = 970,                               /* -d */
  OPT_debuglib_ = 971,                       /* -debuglib= */
  OPT_defaultlib_ = 972,                     /* -defaultlib= */
  OPT_defined_only = 973,                    /* -defined-only */
  OPT_demangle = 974,                        /* -demangle */
  OPT_dialect = 975,                         /* -dialect */
  OPT_dstartfiles = 976,                     /* -dstartfiles */
  OPT_dump_body_ = 977,                      /* -dump-body= */
  OPT_dump_level_ = 978,                     /* -dump-level= */
  OPT_dumpbase = 979,                        /* -dumpbase */
  OPT_dumpbase_ext = 980,                    /* -dumpbase-ext */
  OPT_dumpdir = 981,                         /* -dumpdir */
  OPT_dumpfullversion = 982,                 /* -dumpfullversion */
  OPT_dumpmachine = 983,                     /* -dumpmachine */
  OPT_dumpspecs = 984,                       /* -dumpspecs */
  OPT_dumpversion = 985,                     /* -dumpversion */
  OPT_e = 986,                               /* -e */
  OPT_export_dynamic = 987,                  /* -export-dynamic */
  OPT_fPIC = 988,                            /* -fPIC */
  OPT_fPIE = 989,                            /* -fPIE */
  OPT_fRTS_ = 990,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 991,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 992,                   /* -fabi-version= */
  OPT_faccess_control = 993,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 994,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 995,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 996,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 997,                  /* -falign-commons */
  OPT_falign_functions = 998,                /* -falign-functions */
  OPT_falign_functions_ = 999,               /* -falign-functions= */
  OPT_falign_jumps = 1000,                   /* -falign-jumps */
  OPT_falign_jumps_ = 1001,                  /* -falign-jumps= */
  OPT_falign_labels = 1002,                  /* -falign-labels */
  OPT_falign_labels_ = 1003,                 /* -falign-labels= */
  OPT_falign_loops = 1004,                   /* -falign-loops */
  OPT_falign_loops_ = 1005,                  /* -falign-loops= */
  /* OPT_faligned_new = 1006, */             /* -faligned-new */
  OPT_faligned_new_ = 1007,                  /* -faligned-new= */
  OPT_fall_instantiations = 1008,            /* -fall-instantiations */
  OPT_fall_intrinsics = 1009,                /* -fall-intrinsics */
  OPT_fall_virtual = 1010,                   /* -fall-virtual */
  OPT_fallocation_dce = 1011,                /* -fallocation-dce */
  OPT_fallow_argument_mismatch = 1012,       /* -fallow-argument-mismatch */
  OPT_fallow_invalid_boz = 1013,             /* -fallow-invalid-boz */
  OPT_fallow_leading_underscore = 1014,      /* -fallow-leading-underscore */
  /* OPT_fallow_parameterless_variadic_functions = 1015, *//* -fallow-parameterless-variadic-functions */
  OPT_fallow_store_data_races = 1016,        /* -fallow-store-data-races */
  OPT_falt_external_templates = 1017,        /* -falt-external-templates */
  OPT_fanalyzer = 1018,                      /* -fanalyzer */
  OPT_fanalyzer_call_summaries = 1019,       /* -fanalyzer-call-summaries */
  OPT_fanalyzer_checker_ = 1020,             /* -fanalyzer-checker= */
  OPT_fanalyzer_debug_text_art = 1021,       /* -fanalyzer-debug-text-art */
  OPT_fanalyzer_feasibility = 1022,          /* -fanalyzer-feasibility */
  OPT_fanalyzer_fine_grained = 1023,         /* -fanalyzer-fine-grained */
  OPT_fanalyzer_show_duplicate_count = 1024, /* -fanalyzer-show-duplicate-count */
  OPT_fanalyzer_show_events_in_system_headers = 1025,/* -fanalyzer-show-events-in-system-headers */
  OPT_fanalyzer_state_merge = 1026,          /* -fanalyzer-state-merge */
  OPT_fanalyzer_state_purge = 1027,          /* -fanalyzer-state-purge */
  OPT_fanalyzer_suppress_followups = 1028,   /* -fanalyzer-suppress-followups */
  OPT_fanalyzer_transitivity = 1029,         /* -fanalyzer-transitivity */
  OPT_fanalyzer_undo_inlining = 1030,        /* -fanalyzer-undo-inlining */
  OPT_fanalyzer_verbose_edges = 1031,        /* -fanalyzer-verbose-edges */
  OPT_fanalyzer_verbose_state_changes = 1032,/* -fanalyzer-verbose-state-changes */
  OPT_fanalyzer_verbosity_ = 1033,           /* -fanalyzer-verbosity= */
  /* OPT_fargument_alias = 1034, */          /* -fargument-alias */
  /* OPT_fargument_noalias = 1035, */        /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 1036, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 1037, */ /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 1038,           /* -fasan-shadow-offset= */
  OPT_fasm = 1039,                           /* -fasm */
  OPT_fassert = 1040,                        /* -fassert */
  OPT_fassociative_math = 1041,              /* -fassociative-math */
  OPT_fassume_sane_operators_new_delete = 1042,/* -fassume-sane-operators-new-delete */
  OPT_fasynchronous_unwind_tables = 1043,    /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 1044,                  /* -fauto-inc-dec */
  OPT_fauto_init = 1045,                     /* -fauto-init */
  OPT_fauto_profile = 1046,                  /* -fauto-profile */
  OPT_fauto_profile_ = 1047,                 /* -fauto-profile= */
  OPT_fautomatic = 1048,                     /* -fautomatic */
  OPT_favoid_store_forwarding = 1049,        /* -favoid-store-forwarding */
  OPT_fbackslash = 1050,                     /* -fbackslash */
  OPT_fbacktrace = 1051,                     /* -fbacktrace */
  OPT_fbit_tests = 1052,                     /* -fbit-tests */
  OPT_fblas_matmul_limit_ = 1053,            /* -fblas-matmul-limit= */
  OPT_fbounds = 1054,                        /* -fbounds */
  OPT_fbounds_check = 1055,                  /* -fbounds-check */
  OPT_fbounds_check_ = 1056,                 /* -fbounds-check= */
  OPT_fbranch_count_reg = 1057,              /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 1058,          /* -fbranch-probabilities */
  /* OPT_fbranch_target_load_optimize = 1059, *//* -fbranch-target-load-optimize */
  /* OPT_fbranch_target_load_optimize2 = 1060, *//* -fbranch-target-load-optimize2 */
  /* OPT_fbtr_bb_exclusive = 1061, */        /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 1062,               /* -fbuilding-libgcc */
  OPT_fbuilding_libgfortran = 1063,          /* -fbuilding-libgfortran */
  OPT_fbuilding_libphobos_tests = 1064,      /* -fbuilding-libphobos-tests */
  OPT_fbuiltin = 1065,                       /* -fbuiltin */
  OPT_fbuiltin_ = 1066,                      /* -fbuiltin- */
  OPT_fbuiltin_printf = 1067,                /* -fbuiltin-printf */
  OPT_fc_prototypes = 1068,                  /* -fc-prototypes */
  OPT_fc_prototypes_external = 1069,         /* -fc-prototypes-external */
  OPT_fcall_saved_ = 1070,                   /* -fcall-saved- */
  OPT_fcall_used_ = 1071,                    /* -fcall-used- */
  OPT_fcaller_saves = 1072,                  /* -fcaller-saves */
  OPT_fcallgraph_info = 1073,                /* -fcallgraph-info */
  OPT_fcallgraph_info_ = 1074,               /* -fcallgraph-info= */
  OPT_fcanon_prefix_map = 1075,              /* -fcanon-prefix-map */
  OPT_fcanonical_system_headers = 1076,      /* -fcanonical-system-headers */
  OPT_fcase = 1077,                          /* -fcase */
  /* OPT_fcf_protection = 1078, */           /* -fcf-protection */
  OPT_fcf_protection_ = 1079,                /* -fcf-protection= */
  OPT_fchar8_t = 1080,                       /* -fchar8_t */
  OPT_fcheck_array_temporaries = 1081,       /* -fcheck-array-temporaries */
  /* OPT_fcheck_data_deps = 1082, */         /* -fcheck-data-deps */
  OPT_fcheck_new = 1083,                     /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 1084,          /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 1085,                        /* -fcheck= */
  /* OPT_fcheck_assert = 1086, */            /* -fcheck=assert */
  /* OPT_fcheck_bounds = 1087, */            /* -fcheck=bounds */
  /* OPT_fcheck_in = 1088, */                /* -fcheck=in */
  /* OPT_fcheck_invariant = 1089, */         /* -fcheck=invariant */
  /* OPT_fcheck_out = 1090, */               /* -fcheck=out */
  /* OPT_fcheck_switch = 1091, */            /* -fcheck=switch */
  OPT_fcheckaction_ = 1092,                  /* -fcheckaction= */
  OPT_fchecking = 1093,                      /* -fchecking */
  OPT_fchecking_ = 1094,                     /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 1095,    /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 1096,               /* -fchkp-check-read */
  OPT_fchkp_check_write = 1097,              /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 1098,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 1099,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 1100,         /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 1101,   /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 1102,            /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 1103,/* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 1104,                 /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 1105,             /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 1106,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 1107,/* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 1108,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 1109,        /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 1110,  /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 1111,             /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 1112,/* -fchkp-zero-input-bounds-for-main */
  /* OPT_fcilkplus = 1113, */                /* -fcilkplus */
  OPT_fcoarray_ = 1114,                      /* -fcoarray= */
  OPT_fcobol_exceptions = 1115,              /* -fcobol-exceptions */
  OPT_fcode_hoisting = 1116,                 /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 1117,     /* -fcombine-stack-adjustments */
  OPT_fcommon = 1118,                        /* -fcommon */
  OPT_fcompare_debug = 1119,                 /* -fcompare-debug */
  OPT_fcompare_debug_second = 1120,          /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 1121,                /* -fcompare-debug= */
  OPT_fcompare_elim = 1122,                  /* -fcompare-elim */
  OPT_fconcepts = 1123,                      /* -fconcepts */
  OPT_fconcepts_diagnostics_depth_ = 1124,   /* -fconcepts-diagnostics-depth= */
  OPT_fconcepts_ts = 1125,                   /* -fconcepts-ts */
  OPT_fcond_mismatch = 1126,                 /* -fcond-mismatch */
  OPT_fcondition_coverage = 1127,            /* -fcondition-coverage */
  /* OPT_fconserve_space = 1128, */          /* -fconserve-space */
  OPT_fconserve_stack = 1129,                /* -fconserve-stack */
  OPT_fconstant_string_class_ = 1130,        /* -fconstant-string-class= */
  OPT_fconstexpr_cache_depth_ = 1131,        /* -fconstexpr-cache-depth= */
  OPT_fconstexpr_depth_ = 1132,              /* -fconstexpr-depth= */
  OPT_fconstexpr_fp_except = 1133,           /* -fconstexpr-fp-except */
  OPT_fconstexpr_loop_limit_ = 1134,         /* -fconstexpr-loop-limit= */
  OPT_fconstexpr_ops_limit_ = 1135,          /* -fconstexpr-ops-limit= */
  OPT_fcontract_assumption_mode_ = 1136,     /* -fcontract-assumption-mode= */
  OPT_fcontract_build_level_ = 1137,         /* -fcontract-build-level= */
  OPT_fcontract_continuation_mode_ = 1138,   /* -fcontract-continuation-mode= */
  OPT_fcontract_mode_ = 1139,                /* -fcontract-mode= */
  OPT_fcontract_role_ = 1140,                /* -fcontract-role= */
  OPT_fcontract_semantic_ = 1141,            /* -fcontract-semantic= */
  OPT_fcontract_strict_declarations_ = 1142, /* -fcontract-strict-declarations= */
  OPT_fcontracts = 1143,                     /* -fcontracts */
  OPT_fconvert_ = 1144,                      /* -fconvert= */
  OPT_fcoroutines = 1145,                    /* -fcoroutines */
  OPT_fcpp = 1146,                           /* -fcpp */
  OPT_fcpp_begin = 1147,                     /* -fcpp-begin */
  OPT_fcpp_end = 1148,                       /* -fcpp-end */
  OPT_fcprop_registers = 1149,               /* -fcprop-registers */
  OPT_fcray_pointer = 1150,                  /* -fcray-pointer */
  OPT_fcrossjumping = 1151,                  /* -fcrossjumping */
  OPT_fcse_follow_jumps = 1152,              /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 1153, */         /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 1154,              /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 1155,              /* -fcx-limited-range */
  OPT_fd = 1156,                             /* -fd */
  OPT_fd_lines_as_code = 1157,               /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 1158,           /* -fd-lines-as-comments */
  OPT_fdata_sections = 1159,                 /* -fdata-sections */
  OPT_fdbg_cnt_list = 1160,                  /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 1161,                      /* -fdbg-cnt= */
  OPT_fdce = 1162,                           /* -fdce */
  OPT_fdebug = 1163,                         /* -fdebug */
  OPT_fdebug_aux_vars = 1164,                /* -fdebug-aux-vars */
  OPT_fdebug_builtins = 1165,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1166,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1167,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1168,             /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 1169,           /* -fdebug-types-section */
  OPT_fdebug_ = 1170,                        /* -fdebug= */
  OPT_fdec = 1171,                           /* -fdec */
  OPT_fdec_blank_format_item = 1172,         /* -fdec-blank-format-item */
  OPT_fdec_char_conversions = 1173,          /* -fdec-char-conversions */
  OPT_fdec_format_defaults = 1174,           /* -fdec-format-defaults */
  OPT_fdec_include = 1175,                   /* -fdec-include */
  OPT_fdec_intrinsic_ints = 1176,            /* -fdec-intrinsic-ints */
  OPT_fdec_math = 1177,                      /* -fdec-math */
  OPT_fdec_static = 1178,                    /* -fdec-static */
  OPT_fdec_structure = 1179,                 /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 1180,             /* -fdeclone-ctor-dtor */
  /* OPT_fdeduce_init_list = 1181, */        /* -fdeduce-init-list */
  OPT_fdef_ = 1182,                          /* -fdef= */
  OPT_fdefault_double_8 = 1183,              /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 1184, */          /* -fdefault-inline */
  OPT_fdefault_integer_8 = 1185,             /* -fdefault-integer-8 */
  OPT_fdefault_real_10 = 1186,               /* -fdefault-real-10 */
  OPT_fdefault_real_16 = 1187,               /* -fdefault-real-16 */
  OPT_fdefault_real_8 = 1188,                /* -fdefault-real-8 */
  OPT_fdefaultbyte = 1189,                   /* -fdefaultbyte */
  OPT_fdefer_pop = 1190,                     /* -fdefer-pop */
  OPT_fdelayed_branch = 1191,                /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 1192,        /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 1193,    /* -fdelete-null-pointer-checks */
  OPT_fdeps_file_ = 1194,                    /* -fdeps-file= */
  OPT_fdeps_format_ = 1195,                  /* -fdeps-format= */
  OPT_fdeps_target_ = 1196,                  /* -fdeps-target= */
  OPT_fdevirtualize = 1197,                  /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 1198,        /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 1199,    /* -fdevirtualize-speculatively */
  OPT_fdiagnostics_add_output_ = 1200,       /* -fdiagnostics-add-output= */
  OPT_fdiagnostics_all_candidates = 1201,    /* -fdiagnostics-all-candidates */
  /* OPT_fdiagnostics_color = 1202, */       /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 1203,            /* -fdiagnostics-color= */
  OPT_fdiagnostics_column_origin_ = 1204,    /* -fdiagnostics-column-origin= */
  OPT_fdiagnostics_column_unit_ = 1205,      /* -fdiagnostics-column-unit= */
  OPT_fdiagnostics_escape_format_ = 1206,    /* -fdiagnostics-escape-format= */
  OPT_fdiagnostics_format_ = 1207,           /* -fdiagnostics-format= */
  OPT_fdiagnostics_generate_patch = 1208,    /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_json_formatting = 1209,   /* -fdiagnostics-json-formatting */
  OPT_fdiagnostics_minimum_margin_width_ = 1210,/* -fdiagnostics-minimum-margin-width= */
  OPT_fdiagnostics_parseable_fixits = 1211,  /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_path_format_ = 1212,      /* -fdiagnostics-path-format= */
  OPT_fdiagnostics_plain_output = 1213,      /* -fdiagnostics-plain-output */
  OPT_fdiagnostics_set_output_ = 1214,       /* -fdiagnostics-set-output= */
  OPT_fdiagnostics_show_caret = 1215,        /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_cwe = 1216,          /* -fdiagnostics-show-cwe */
  OPT_fdiagnostics_show_event_links = 1217,  /* -fdiagnostics-show-event-links */
  OPT_fdiagnostics_show_highlight_colors = 1218,/* -fdiagnostics-show-highlight-colors */
  OPT_fdiagnostics_show_labels = 1219,       /* -fdiagnostics-show-labels */
  OPT_fdiagnostics_show_line_numbers = 1220, /* -fdiagnostics-show-line-numbers */
  OPT_fdiagnostics_show_location_ = 1221,    /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 1222,       /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_path_depths = 1223,  /* -fdiagnostics-show-path-depths */
  OPT_fdiagnostics_show_rules = 1224,        /* -fdiagnostics-show-rules */
  OPT_fdiagnostics_show_template_tree = 1225,/* -fdiagnostics-show-template-tree */
  OPT_fdiagnostics_text_art_charset_ = 1226, /* -fdiagnostics-text-art-charset= */
  OPT_fdiagnostics_urls_ = 1227,             /* -fdiagnostics-urls= */
  OPT_fdirectives_only = 1228,               /* -fdirectives-only */
  OPT_fdisable_ = 1229,                      /* -fdisable- */
  OPT_fdoc = 1230,                           /* -fdoc */
  OPT_fdoc_dir_ = 1231,                      /* -fdoc-dir= */
  OPT_fdoc_file_ = 1232,                     /* -fdoc-file= */
  OPT_fdoc_inc_ = 1233,                      /* -fdoc-inc= */
  OPT_fdollar_ok = 1234,                     /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 1235,        /* -fdollars-in-identifiers */
  OPT_fdruntime = 1236,                      /* -fdruntime */
  OPT_fdse = 1237,                           /* -fdse */
  OPT_fdump_ = 1238,                         /* -fdump- */
  OPT_fdump_ada_spec = 1239,                 /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 1240,            /* -fdump-ada-spec-slim */
  OPT_fdump_analyzer = 1241,                 /* -fdump-analyzer */
  OPT_fdump_analyzer_callgraph = 1242,       /* -fdump-analyzer-callgraph */
  OPT_fdump_analyzer_exploded_graph = 1243,  /* -fdump-analyzer-exploded-graph */
  OPT_fdump_analyzer_exploded_nodes = 1244,  /* -fdump-analyzer-exploded-nodes */
  OPT_fdump_analyzer_exploded_nodes_2 = 1245,/* -fdump-analyzer-exploded-nodes-2 */
  OPT_fdump_analyzer_exploded_nodes_3 = 1246,/* -fdump-analyzer-exploded-nodes-3 */
  OPT_fdump_analyzer_exploded_paths = 1247,  /* -fdump-analyzer-exploded-paths */
  OPT_fdump_analyzer_feasibility = 1248,     /* -fdump-analyzer-feasibility */
  OPT_fdump_analyzer_infinite_loop = 1249,   /* -fdump-analyzer-infinite-loop */
  OPT_fdump_analyzer_json = 1250,            /* -fdump-analyzer-json */
  OPT_fdump_analyzer_state_purge = 1251,     /* -fdump-analyzer-state-purge */
  OPT_fdump_analyzer_stderr = 1252,          /* -fdump-analyzer-stderr */
  OPT_fdump_analyzer_supergraph = 1253,      /* -fdump-analyzer-supergraph */
  OPT_fdump_analyzer_untracked = 1254,       /* -fdump-analyzer-untracked */
  OPT_fdump_c___spec_verbose = 1255,         /* -fdump-c++-spec-verbose */
  OPT_fdump_c___spec_ = 1256,                /* -fdump-c++-spec= */
  /* OPT_fdump_core = 1257, */               /* -fdump-core */
  OPT_fdump_d_original = 1258,               /* -fdump-d-original */
  OPT_fdump_final_insns = 1259,              /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 1260,             /* -fdump-final-insns= */
  OPT_fdump_fortran_global = 1261,           /* -fdump-fortran-global */
  OPT_fdump_fortran_optimized = 1262,        /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 1263,         /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 1264,                 /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 1265,       /* -fdump-internal-locations */
  OPT_fdump_noaddr = 1266,                   /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 1267, */         /* -fdump-parse-tree */
  OPT_fdump_passes = 1268,                   /* -fdump-passes */
  OPT_fdump_scos = 1269,                     /* -fdump-scos */
  OPT_fdump_system_exports = 1270,           /* -fdump-system-exports */
  OPT_fdump_unnumbered = 1271,               /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 1272,         /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 1273,                /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 1274,                /* -fearly-inlining */
  OPT_felide_constructors = 1275,            /* -felide-constructors */
  OPT_felide_type = 1276,                    /* -felide-type */
  /* OPT_feliminate_dwarf2_dups = 1277, */   /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 1278,/* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 1279,  /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 1280,       /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 1281,    /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 1282,   /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 1283,     /* -femit-struct-debug-reduced */
  OPT_fenable_ = 1284,                       /* -fenable- */
  OPT_fenforce_eh_specs = 1285,              /* -fenforce-eh-specs */
  OPT_fenum_int_equiv = 1286,                /* -fenum-int-equiv */
  OPT_fexceptions = 1287,                    /* -fexceptions */
  OPT_fexcess_precision_ = 1288,             /* -fexcess-precision= */
  OPT_fexec_charset_ = 1289,                 /* -fexec-charset= */
  OPT_fexpensive_optimizations = 1290,       /* -fexpensive-optimizations */
  OPT_fext_dce = 1291,                       /* -fext-dce */
  OPT_fext_numeric_literals = 1292,          /* -fext-numeric-literals */
  OPT_fextended_identifiers = 1293,          /* -fextended-identifiers */
  OPT_fextended_opaque = 1294,               /* -fextended-opaque */
  OPT_fextern_std_ = 1295,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1296,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1297,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1298,            /* -fexternal-templates */
  OPT_ff2c = 1299,                           /* -ff2c */
  OPT_ffast_math = 1300,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1301,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1302,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1303,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1304,              /* -ffinite-math-only */
  OPT_ffixed_ = 1305,                        /* -ffixed- */
  OPT_ffixed_form = 1306,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1307,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1308,        /* -ffixed-line-length-none */
  OPT_fflex_debug = 1309,                    /* -fflex-debug */
  OPT_ffloat_store = 1310,                   /* -ffloat-store */
  OPT_ffloatvalue = 1311,                    /* -ffloatvalue */
  OPT_ffold_mem_offsets = 1312,              /* -ffold-mem-offsets */
  OPT_ffold_simple_inlines = 1313,           /* -ffold-simple-inlines */
  OPT_ffor_scope = 1314,                     /* -ffor-scope */
  /* OPT_fforce_addr = 1315, */              /* -fforce-addr */
  OPT_fforward_propagate = 1316,             /* -fforward-propagate */
  OPT_ffp_contract_ = 1317,                  /* -ffp-contract= */
  OPT_ffp_int_builtin_inexact = 1318,        /* -ffp-int-builtin-inexact */
  OPT_ffpe_summary_ = 1319,                  /* -ffpe-summary= */
  OPT_ffpe_trap_ = 1320,                     /* -ffpe-trap= */
  OPT_ffree_form = 1321,                     /* -ffree-form */
  OPT_ffree_line_length_ = 1322,             /* -ffree-line-length- */
  OPT_ffree_line_length_none = 1323,         /* -ffree-line-length-none */
  OPT_ffreestanding = 1324,                  /* -ffreestanding */
  OPT_ffriend_injection = 1325,              /* -ffriend-injection */
  OPT_ffrontend_loop_interchange = 1326,     /* -ffrontend-loop-interchange */
  OPT_ffrontend_optimize = 1327,             /* -ffrontend-optimize */
  OPT_ffunction_cse = 1328,                  /* -ffunction-cse */
  OPT_ffunction_sections = 1329,             /* -ffunction-sections */
  OPT_fgcse = 1330,                          /* -fgcse */
  OPT_fgcse_after_reload = 1331,             /* -fgcse-after-reload */
  OPT_fgcse_las = 1332,                      /* -fgcse-las */
  OPT_fgcse_lm = 1333,                       /* -fgcse-lm */
  OPT_fgcse_sm = 1334,                       /* -fgcse-sm */
  OPT_fgen_module_list_ = 1335,              /* -fgen-module-list= */
  OPT_fgimple = 1336,                        /* -fgimple */
  OPT_fgnat_encodings_ = 1337,               /* -fgnat-encodings= */
  OPT_fgnu_keywords = 1338,                  /* -fgnu-keywords */
  OPT_fgnu_runtime = 1339,                   /* -fgnu-runtime */
  OPT_fgnu_tm = 1340,                        /* -fgnu-tm */
  OPT_fgnu_unique = 1341,                    /* -fgnu-unique */
  OPT_fgnu89_inline = 1342,                  /* -fgnu89-inline */
  OPT_fgo_c_header_ = 1343,                  /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 1344,      /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 1345,          /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 1346,          /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 1347,               /* -fgo-debug-escape */
  OPT_fgo_debug_escape_hash_ = 1348,         /* -fgo-debug-escape-hash= */
  OPT_fgo_debug_optimization = 1349,         /* -fgo-debug-optimization */
  OPT_fgo_dump_ = 1350,                      /* -fgo-dump- */
  OPT_fgo_embedcfg_ = 1351,                  /* -fgo-embedcfg= */
  OPT_fgo_importcfg_ = 1352,                 /* -fgo-importcfg= */
  OPT_fgo_optimize_ = 1353,                  /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 1354,                   /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 1355,                    /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 1356,      /* -fgo-relative-import-path= */
  OPT_fgraphite = 1357,                      /* -fgraphite */
  OPT_fgraphite_identity = 1358,             /* -fgraphite-identity */
  OPT_fguess_branch_probability = 1359,      /* -fguess-branch-probability */
  OPT_fguiding_decls = 1360,                 /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 1361, */       /* -fhandle-exceptions */
  OPT_fhardcfr_check_exceptions = 1362,      /* -fhardcfr-check-exceptions */
  OPT_fhardcfr_check_noreturn_calls_ = 1363, /* -fhardcfr-check-noreturn-calls= */
  OPT_fhardcfr_check_returning_calls = 1364, /* -fhardcfr-check-returning-calls */
  OPT_fhardcfr_skip_leaf = 1365,             /* -fhardcfr-skip-leaf */
  OPT_fharden_compares = 1366,               /* -fharden-compares */
  OPT_fharden_conditional_branches = 1367,   /* -fharden-conditional-branches */
  OPT_fharden_control_flow_redundancy = 1368,/* -fharden-control-flow-redundancy */
  OPT_fhardened = 1369,                      /* -fhardened */
  /* OPT_fhelp = 1370, */                    /* -fhelp */
  /* OPT_fhelp_ = 1371, */                   /* -fhelp= */
  OPT_fhoist_adjacent_loads = 1372,          /* -fhoist-adjacent-loads */
  OPT_fhonor_std = 1373,                     /* -fhonor-std */
  OPT_fhosted = 1374,                        /* -fhosted */
  OPT_fhuge_objects = 1375,                  /* -fhuge-objects */
  OPT_fident = 1376,                         /* -fident */
  OPT_fif_conversion = 1377,                 /* -fif-conversion */
  OPT_fif_conversion2 = 1378,                /* -fif-conversion2 */
  OPT_fignore_unknown_pragmas = 1379,        /* -fignore-unknown-pragmas */
  OPT_fimmediate_escalation = 1380,          /* -fimmediate-escalation */
  OPT_fimplement_inlines = 1381,             /* -fimplement-inlines */
  OPT_fimplicit_constexpr = 1382,            /* -fimplicit-constexpr */
  OPT_fimplicit_inline_templates = 1383,     /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 1384,                 /* -fimplicit-none */
  OPT_fimplicit_templates = 1385,            /* -fimplicit-templates */
  OPT_finclude_imports = 1386,               /* -finclude-imports */
  OPT_findex = 1387,                         /* -findex */
  OPT_findicator_column = 1388,              /* -findicator-column */
  OPT_findirect_inlining = 1389,             /* -findirect-inlining */
  OPT_finhibit_size_directive = 1390,        /* -finhibit-size-directive */
  OPT_finit_character_ = 1391,               /* -finit-character= */
  OPT_finit_derived = 1392,                  /* -finit-derived */
  OPT_finit_integer_ = 1393,                 /* -finit-integer= */
  OPT_finit_local_zero = 1394,               /* -finit-local-zero */
  OPT_finit_logical_ = 1395,                 /* -finit-logical= */
  OPT_finit_real_ = 1396,                    /* -finit-real= */
  OPT_finline = 1397,                        /* -finline */
  OPT_finline_arg_packing = 1398,            /* -finline-arg-packing */
  OPT_finline_atomics = 1399,                /* -finline-atomics */
  OPT_finline_functions = 1400,              /* -finline-functions */
  OPT_finline_functions_called_once = 1401,  /* -finline-functions-called-once */
  OPT_finline_intrinsics = 1402,             /* -finline-intrinsics */
  OPT_finline_intrinsics_ = 1403,            /* -finline-intrinsics= */
  /* OPT_finline_limit_ = 1404, */           /* -finline-limit- */
  OPT_finline_limit_ = 1405,                 /* -finline-limit= */
  OPT_finline_matmul_limit_ = 1406,          /* -finline-matmul-limit= */
  OPT_finline_small_functions = 1407,        /* -finline-small-functions */
  OPT_finline_stringops = 1408,              /* -finline-stringops */
  OPT_finline_stringops_ = 1409,             /* -finline-stringops= */
  OPT_finput_charset_ = 1410,                /* -finput-charset= */
  OPT_finstrument_functions = 1411,          /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 1412,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 1413,/* -finstrument-functions-exclude-function-list= */
  OPT_finstrument_functions_once = 1414,     /* -finstrument-functions-once */
  OPT_finteger_4_integer_8 = 1415,           /* -finteger-4-integer-8 */
  OPT_finternal_ebcdic = 1416,               /* -finternal-ebcdic */
  OPT_fintrinsic_modules_path = 1417,        /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 1418,       /* -fintrinsic-modules-path= */
  OPT_finvariants = 1419,                    /* -finvariants */
  OPT_fipa_bit_cp = 1420,                    /* -fipa-bit-cp */
  OPT_fipa_cp = 1421,                        /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 1422, */        /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 1423,                  /* -fipa-cp-clone */
  OPT_fipa_icf = 1424,                       /* -fipa-icf */
  OPT_fipa_icf_functions = 1425,             /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 1426,             /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 1427, */        /* -fipa-matrix-reorg */
  OPT_fipa_modref = 1428,                    /* -fipa-modref */
  OPT_fipa_profile = 1429,                   /* -fipa-profile */
  OPT_fipa_pta = 1430,                       /* -fipa-pta */
  OPT_fipa_pure_const = 1431,                /* -fipa-pure-const */
  OPT_fipa_ra = 1432,                        /* -fipa-ra */
  OPT_fipa_reference = 1433,                 /* -fipa-reference */
  OPT_fipa_reference_addressable = 1434,     /* -fipa-reference-addressable */
  OPT_fipa_reorder_for_locality = 1435,      /* -fipa-reorder-for-locality */
  OPT_fipa_sra = 1436,                       /* -fipa-sra */
  OPT_fipa_stack_alignment = 1437,           /* -fipa-stack-alignment */
  OPT_fipa_strict_aliasing = 1438,           /* -fipa-strict-aliasing */
  /* OPT_fipa_struct_reorg = 1439, */        /* -fipa-struct-reorg */
  OPT_fipa_vrp = 1440,                       /* -fipa-vrp */
  OPT_fira_algorithm_ = 1441,                /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 1442,            /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 1443,             /* -fira-loop-pressure */
  OPT_fira_region_ = 1444,                   /* -fira-region= */
  OPT_fira_share_save_slots = 1445,          /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 1446,         /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 1447,                  /* -fira-verbose= */
  OPT_fiso = 1448,                           /* -fiso */
  OPT_fisolate_erroneous_paths_attribute = 1449,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 1450,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 1451,              /* -fivar-visibility= */
  OPT_fivopts = 1452,                        /* -fivopts */
  OPT_fjump_tables = 1453,                   /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 1454,            /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 1455,         /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 1456,         /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 1457,            /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 1458,         /* -fkeep-static-functions */
  OPT_flabels_ok = 1459,                     /* -flabels-ok */
  OPT_flang_info_include_translate = 1460,   /* -flang-info-include-translate */
  OPT_flang_info_include_translate_not = 1461,/* -flang-info-include-translate-not */
  OPT_flang_info_include_translate_ = 1462,  /* -flang-info-include-translate= */
  OPT_flang_info_module_cmi = 1463,          /* -flang-info-module-cmi */
  OPT_flang_info_module_cmi_ = 1464,         /* -flang-info-module-cmi= */
  /* OPT_flarge_source_files = 1465, */      /* -flarge-source-files */
  OPT_flate_combine_instructions = 1466,     /* -flate-combine-instructions */
  OPT_flax_vector_conversions = 1467,        /* -flax-vector-conversions */
  OPT_fleading_underscore = 1468,            /* -fleading-underscore */
  OPT_flibs_ = 1469,                         /* -flibs= */
  OPT_flifetime_dse = 1470,                  /* -flifetime-dse */
  OPT_flifetime_dse_ = 1471,                 /* -flifetime-dse= */
  OPT_flimit_function_alignment = 1472,      /* -flimit-function-alignment */
  OPT_flinker_output_ = 1473,                /* -flinker-output= */
  /* OPT_flive_patching = 1474, */           /* -flive-patching */
  OPT_flive_patching_ = 1475,                /* -flive-patching= */
  OPT_flive_range_shrinkage = 1476,          /* -flive-range-shrinkage */
  OPT_flocal_ivars = 1477,                   /* -flocal-ivars */
  OPT_flocation_ = 1478,                     /* -flocation= */
  /* OPT_floop_block = 1479, */              /* -floop-block */
  /* OPT_floop_flatten = 1480, */            /* -floop-flatten */
  OPT_floop_interchange = 1481,              /* -floop-interchange */
  OPT_floop_nest_optimize = 1482,            /* -floop-nest-optimize */
  /* OPT_floop_optimize = 1483, */           /* -floop-optimize */
  OPT_floop_parallelize_all = 1484,          /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 1485, */         /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 1486,           /* -floop-unroll-and-jam */
  OPT_flra_remat = 1487,                     /* -flra-remat */
  OPT_flto = 1488,                           /* -flto */
  OPT_flto_compression_level_ = 1489,        /* -flto-compression-level= */
  OPT_flto_incremental_cache_size_ = 1490,   /* -flto-incremental-cache-size= */
  OPT_flto_incremental_ = 1491,              /* -flto-incremental= */
  /* OPT_flto_odr_type_merging = 1492, */    /* -flto-odr-type-merging */
  OPT_flto_partition_ = 1493,                /* -flto-partition= */
  OPT_flto_report = 1494,                    /* -flto-report */
  OPT_flto_report_wpa = 1495,                /* -flto-report-wpa */
  OPT_flto_ = 1496,                          /* -flto= */
  OPT_fltrans = 1497,                        /* -fltrans */
  OPT_fltrans_output_list_ = 1498,           /* -fltrans-output-list= */
  OPT_fm2_debug_trace_ = 1499,               /* -fm2-debug-trace= */
  OPT_fm2_dump_decl_ = 1500,                 /* -fm2-dump-decl= */
  OPT_fm2_dump_filter_ = 1501,               /* -fm2-dump-filter= */
  OPT_fm2_dump_gimple_ = 1502,               /* -fm2-dump-gimple= */
  OPT_fm2_dump_quad_ = 1503,                 /* -fm2-dump-quad= */
  OPT_fm2_dump_ = 1504,                      /* -fm2-dump= */
  OPT_fm2_file_offset_bits_ = 1505,          /* -fm2-file-offset-bits= */
  OPT_fm2_g = 1506,                          /* -fm2-g */
  OPT_fm2_lower_case = 1507,                 /* -fm2-lower-case */
  OPT_fm2_pathname_ = 1508,                  /* -fm2-pathname= */
  OPT_fm2_pathnameI = 1509,                  /* -fm2-pathnameI */
  OPT_fm2_plugin = 1510,                     /* -fm2-plugin */
  OPT_fm2_prefix_ = 1511,                    /* -fm2-prefix= */
  OPT_fm2_statistics = 1512,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1513,                /* -fm2-strict-type */
  OPT_fm2_whole_program = 1514,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1515,             /* -fmacro-prefix-map= */
  OPT_fmain = 1516,                          /* -fmain */
  OPT_fmalloc_dce = 1517,                    /* -fmalloc-dce */
  OPT_fmalloc_dce_ = 1518,                   /* -fmalloc-dce= */
  OPT_fmath_errno = 1519,                    /* -fmath-errno */
  OPT_fmax_array_constructor_ = 1520,        /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 1521,                   /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 1522,        /* -fmax-identifier-length= */
  OPT_fmax_include_depth_ = 1523,            /* -fmax-include-depth= */
  OPT_fmax_stack_var_size_ = 1524,           /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 1525,         /* -fmax-subrecord-length= */
  OPT_fmem_report = 1526,                    /* -fmem-report */
  OPT_fmem_report_wpa = 1527,                /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 1528,           /* -fmerge-all-constants */
  OPT_fmerge_constants = 1529,               /* -fmerge-constants */
  OPT_fmerge_debug_strings = 1530,           /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 1531,               /* -fmessage-length= */
  OPT_fmin_function_alignment_ = 1532,       /* -fmin-function-alignment= */
  OPT_fmod_ = 1533,                          /* -fmod= */
  OPT_fmodule_file_ = 1534,                  /* -fmodule-file= */
  OPT_fmodule_header = 1535,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1536,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1537,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1538,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1539,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1540,                   /* -fmodule-only */
  OPT_fmodule_private = 1541,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1542,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1543,                    /* -fmoduleinfo */
  OPT_fmodules = 1544,                       /* -fmodules */
  /* OPT_fmodules_ts = 1545, */              /* -fmodules-ts */
  OPT_fmodulo_sched = 1546,                  /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 1547,   /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 1548,          /* -fmove-loop-invariants */
  OPT_fmove_loop_stores = 1549,              /* -fmove-loop-stores */
  OPT_fms_extensions = 1550,                 /* -fms-extensions */
  OPT_fmudflap = 1551,                       /* -fmudflap */
  OPT_fmudflapir = 1552,                     /* -fmudflapir */
  OPT_fmudflapth = 1553,                     /* -fmudflapth */
  OPT_fmultiflags = 1554,                    /* -fmultiflags */
  OPT_fname_mangling_version_ = 1555,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1556,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1557,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1558,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1559,                  /* -fnext-runtime */
  OPT_fnil = 1560,                           /* -fnil */
  OPT_fnil_receivers = 1561,                 /* -fnil-receivers */
  OPT_fno_inline_intrinsics = 1562,          /* -fno-inline-intrinsics */
  OPT_fno_inline_stringops = 1563,           /* -fno-inline-stringops */
  OPT_fnon_call_exceptions = 1564,           /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 1565,              /* -fnonansi-builtins */
  OPT_fnonnull_objects = 1566,               /* -fnonnull-objects */
  OPT_fnothrow_opt = 1567,                   /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 1568,             /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 1569,          /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 1570,          /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 1571,               /* -fobjc-exceptions */
  OPT_fobjc_gc = 1572,                       /* -fobjc-gc */
  OPT_fobjc_nilcheck = 1573,                 /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 1574,          /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 1575,                /* -fobjc-std=objc1 */
  OPT_foffload_abi_host_opts_ = 1576,        /* -foffload-abi-host-opts= */
  OPT_foffload_abi_ = 1577,                  /* -foffload-abi= */
  OPT_foffload_options_ = 1578,              /* -foffload-options= */
  OPT_foffload_ = 1579,                      /* -foffload= */
  OPT_fomit_frame_pointer = 1580,            /* -fomit-frame-pointer */
  OPT_fonly_ = 1581,                         /* -fonly= */
  OPT_fopenacc = 1582,                       /* -fopenacc */
  OPT_fopenacc_dim_ = 1583,                  /* -fopenacc-dim= */
  OPT_fopenmp = 1584,                        /* -fopenmp */
  OPT_fopenmp_allocators = 1585,             /* -fopenmp-allocators */
  OPT_fopenmp_simd = 1586,                   /* -fopenmp-simd */
  /* OPT_fopenmp_target_simd_clone = 1587, *//* -fopenmp-target-simd-clone */
  OPT_fopenmp_target_simd_clone_ = 1588,     /* -fopenmp-target-simd-clone= */
  OPT_foperator_names = 1589,                /* -foperator-names */
  OPT_fopt_info = 1590,                      /* -fopt-info */
  OPT_fopt_info_ = 1591,                     /* -fopt-info- */
  OPT_foptimize_crc = 1592,                  /* -foptimize-crc */
  /* OPT_foptimize_register_move = 1593, */  /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 1594,        /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 1595,               /* -foptimize-strlen */
  /* OPT_foptional_diags = 1596, */          /* -foptional-diags */
  OPT_fpack_derived = 1597,                  /* -fpack-derived */
  OPT_fpack_struct = 1598,                   /* -fpack-struct */
  OPT_fpack_struct_ = 1599,                  /* -fpack-struct= */
  OPT_fpad_source = 1600,                    /* -fpad-source */
  OPT_fpartial_inlining = 1601,              /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 1602,     /* -fpatchable-function-entry= */
  OPT_fpath_coverage = 1603,                 /* -fpath-coverage */
  OPT_fpath_coverage_limit_ = 1604,          /* -fpath-coverage-limit= */
  OPT_fpcc_struct_return = 1605,             /* -fpcc-struct-return */
  OPT_fpch_deps = 1606,                      /* -fpch-deps */
  OPT_fpch_preprocess = 1607,                /* -fpch-preprocess */
  OPT_fpeel_loops = 1608,                    /* -fpeel-loops */
  OPT_fpeephole = 1609,                      /* -fpeephole */
  OPT_fpeephole2 = 1610,                     /* -fpeephole2 */
  OPT_fpermissive = 1611,                    /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 1612,   /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 1613,                           /* -fpic */
  OPT_fpie = 1614,                           /* -fpie */
  OPT_fpim = 1615,                           /* -fpim */
  OPT_fpim2 = 1616,                          /* -fpim2 */
  OPT_fpim3 = 1617,                          /* -fpim3 */
  OPT_fpim4 = 1618,                          /* -fpim4 */
  OPT_fplan9_extensions = 1619,              /* -fplan9-extensions */
  OPT_fplt = 1620,                           /* -fplt */
  OPT_fplugin_arg_ = 1621,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1622,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1623,        /* -fpositive-mod-floor-div */
  OPT_fpost_ipa_mem_report = 1624,           /* -fpost-ipa-mem-report */
  OPT_fpostconditions = 1625,                /* -fpostconditions */
  OPT_fpre_include_ = 1626,                  /* -fpre-include= */
  OPT_fpre_ipa_mem_report = 1627,            /* -fpre-ipa-mem-report */
  OPT_fpreconditions = 1628,                 /* -fpreconditions */
  OPT_fpredictive_commoning = 1629,          /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 1630,          /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 1631,                  /* -fpreprocessed */
  OPT_fpretty_templates = 1632,              /* -fpretty-templates */
  OPT_fpreview_all = 1633,                   /* -fpreview=all */
  OPT_fpreview_bitfields = 1634,             /* -fpreview=bitfields */
  OPT_fpreview_dip1000 = 1635,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1636,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1637,               /* -fpreview=dip1021 */
  OPT_fpreview_dtorfields = 1638,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1639,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1640,          /* -fpreview=fixaliasthis */
  OPT_fpreview_fiximmutableconv = 1641,      /* -fpreview=fiximmutableconv */
  OPT_fpreview_in = 1642,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1643,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1644,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1645,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_safer = 1646,                 /* -fpreview=safer */
  OPT_fpreview_systemvariables = 1647,       /* -fpreview=systemvariables */
  OPT_fprintf_return_value = 1648,           /* -fprintf-return-value */
  OPT_fprofile = 1649,                       /* -fprofile */
  OPT_fprofile_abs_path = 1650,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1651,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1652,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1653,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1654,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1655,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1656,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1657,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1658,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1659,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1660,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1661,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1662,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1663,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1664,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1665,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1666,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1667,               /* -fprofile-update= */
  OPT_fprofile_use = 1668,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1669,                  /* -fprofile-use= */
  OPT_fprofile_values = 1670,                /* -fprofile-values */
  OPT_fprotect_parens = 1671,                /* -fprotect-parens */
  OPT_fpthread = 1672,                       /* -fpthread */
  OPT_fq = 1673,                             /* -fq */
  OPT_frandom_seed = 1674,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1675,                  /* -frandom-seed= */
  OPT_frange = 1676,                         /* -frange */
  OPT_frange_check = 1677,                   /* -frange-check */
  OPT_frange_for_ext_temps = 1678,           /* -frange-for-ext-temps */
  OPT_freal_4_real_10 = 1679,                /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 1680,                /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 1681,                 /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 1682,                /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 1683,                /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 1684,                 /* -freal-8-real-4 */
  OPT_frealloc_lhs = 1685,                   /* -frealloc-lhs */
  OPT_freciprocal_math = 1686,               /* -freciprocal-math */
  OPT_frecord_gcc_switches = 1687,           /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 1688,               /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 1689,               /* -frecord-marker=8 */
  OPT_frecursive = 1690,                     /* -frecursive */
  OPT_free = 1691,                           /* -free */
  /* OPT_freg_struct_return = 1692, */       /* -freg-struct-return */
  /* OPT_fregmove = 1693, */                 /* -fregmove */
  OPT_frelease = 1694,                       /* -frelease */
  OPT_frename_registers = 1695,              /* -frename-registers */
  OPT_freorder_blocks = 1696,                /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 1697,     /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 1698,  /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 1699,             /* -freorder-functions */
  OPT_frepack_arrays = 1700,                 /* -frepack-arrays */
  OPT_freplace_objc_classes = 1701,          /* -freplace-objc-classes */
  OPT_frepo = 1702,                          /* -frepo */
  OPT_freport_bug = 1703,                    /* -freport-bug */
  OPT_frequire_return_statement = 1704,      /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 1705,          /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 1706, */          /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 1707,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 1708,                   /* -fresolution= */
  OPT_freturn = 1709,                        /* -freturn */
  OPT_frevert_all = 1710,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1711,                /* -frevert=dip1000 */
  OPT_frevert_dtorfields = 1712,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1713,             /* -frevert=intpromote */
  OPT_frounding_math = 1714,                 /* -frounding-math */
  OPT_frtti = 1715,                          /* -frtti */
  OPT_fruntime_modules_ = 1716,              /* -fruntime-modules= */
  OPT_frust_borrowcheck = 1717,              /* -frust-borrowcheck */
  OPT_frust_cfg_ = 1718,                     /* -frust-cfg= */
  OPT_frust_compile_until_ = 1719,           /* -frust-compile-until= */
  OPT_frust_crate_type_ = 1720,              /* -frust-crate-type= */
  OPT_frust_crate_ = 1721,                   /* -frust-crate= */
  OPT_frust_debug = 1722,                    /* -frust-debug */
  OPT_frust_dump_ = 1723,                    /* -frust-dump- */
  OPT_frust_edition_ = 1724,                 /* -frust-edition= */
  OPT_frust_embed_metadata = 1725,           /* -frust-embed-metadata */
  OPT_frust_extern_ = 1726,                  /* -frust-extern= */
  OPT_frust_incomplete_and_experimental_compiler_do_not_use = 1727,/* -frust-incomplete-and-experimental-compiler-do-not-use */
  OPT_frust_mangling_ = 1728,                /* -frust-mangling= */
  OPT_frust_max_recursion_depth_ = 1729,     /* -frust-max-recursion-depth= */
  OPT_frust_metadata_output_ = 1730,         /* -frust-metadata-output= */
  OPT_frust_name_resolution_2_0 = 1731,      /* -frust-name-resolution-2.0 */
  OPT_frust_overflow_checks = 1732,          /* -frust-overflow-checks */
  OPT_frust_panic_ = 1733,                   /* -frust-panic= */
  OPT_fsanitize_address_use_after_scope = 1734,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 1735,            /* -fsanitize-coverage= */
  OPT_fsanitize_recover = 1736,              /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 1737,             /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 1738,            /* -fsanitize-sections= */
  OPT_fsanitize_trap = 1739,                 /* -fsanitize-trap */
  OPT_fsanitize_trap_ = 1740,                /* -fsanitize-trap= */
  /* OPT_fsanitize_undefined_trap_on_error = 1741, *//* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1742,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1743,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1744,      /* -fsave-optimization-record */
  OPT_fscaffold_c = 1745,                    /* -fscaffold-c */
  OPT_fscaffold_c__ = 1746,                  /* -fscaffold-c++ */
  OPT_fscaffold_dynamic = 1747,              /* -fscaffold-dynamic */
  OPT_fscaffold_main = 1748,                 /* -fscaffold-main */
  OPT_fscaffold_static = 1749,               /* -fscaffold-static */
  OPT_fsched_critical_path_heuristic = 1750, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1751,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1752,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1753,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1754,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1755,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1756,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1757,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1758,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1759,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1760,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1761,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1762,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1763,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1764,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1765,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1766,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1767, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1768,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1769,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1770,               /* -fschedule-insns2 */
  OPT_fsearch_include_path = 1771,           /* -fsearch-include-path */
  OPT_fsearch_include_path_ = 1772,          /* -fsearch-include-path= */
  OPT_fsecond_underscore = 1773,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1774,               /* -fsection-anchors */
  /* OPT_fsee = 1775, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1776,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1777,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1778,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1779,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1780,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1781,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1782,        /* -fsemantic-interposition */
  OPT_fshared = 1783,                        /* -fshared */
  OPT_fshort_enums = 1784,                   /* -fshort-enums */
  OPT_fshort_wchar = 1785,                   /* -fshort-wchar */
  OPT_fshow_column = 1786,                   /* -fshow-column */
  OPT_fshrink_wrap = 1787,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1788,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1789,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1790,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1791,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1792,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1793,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1794,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1795,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1796,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1797,                /* -fsoft-check-all */
  OPT_fsources = 1798,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1799,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1800,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1801,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1802,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1803,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1804,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1805,                      /* -fsquangle */
  OPT_fssa_backprop = 1806,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1807,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1808,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1809,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1810, */             /* -fstack-check */
  OPT_fstack_check_ = 1811,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1812,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1813,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1814,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1815,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1816,               /* -fstack-protector */
  OPT_fstack_protector_all = 1817,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1818,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1819,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1820,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1821,                   /* -fstack-usage */
  OPT_fstatic_call = 1822,                   /* -fstatic-call */
  OPT_fstats = 1823,                         /* -fstats */
  OPT_fstdarg_opt = 1824,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1825,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1826, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1827,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1828,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1829, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1830,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1831,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1832,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1833,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1834, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1835,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1836,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1837,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1838,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1839,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1840,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1841,                  /* -fstrub=strict */
  OPT_fswig = 1842,                          /* -fswig */
  OPT_fswitch_errors = 1843,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1844,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1845,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1846,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1847, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1848,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1849, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1850,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1851, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1852,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1853,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1854,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1855,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1856,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1857,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1858,                   /* -ftime-report */
  OPT_ftime_report_details = 1859,           /* -ftime-report-details */
  OPT_ftls_model_ = 1860,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1861,              /* -ftoplevel-reorder */
  OPT_ftrace_debug = 1862,                   /* -ftrace-debug */
  OPT_ftracer = 1863,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1864,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1865,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1866,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1867,                   /* -ftrampolines */
  OPT_ftransition_all = 1868,                /* -ftransition=all */
  OPT_ftransition_field = 1869,              /* -ftransition=field */
  OPT_ftransition_in = 1870,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1871,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1872,          /* -ftransition=templates */
  OPT_ftransition_tls = 1873,                /* -ftransition=tls */
  OPT_ftrapping_math = 1874,                 /* -ftrapping-math */
  OPT_ftrapv = 1875,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1876,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1877,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1878,                      /* -ftree-ccp */
  OPT_ftree_ch = 1879,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1880, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1881,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1882,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1883, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1884,                   /* -ftree-cselim */
  OPT_ftree_dce = 1885,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1886,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1887,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1888,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1889,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1890, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1891,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1892,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1893, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1894,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1895,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1896, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1897,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1898,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1899,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1900,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1901,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1902,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1903,                      /* -ftree-pre */
  OPT_ftree_pta = 1904,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1905,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1906, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1907,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1908,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1909,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1910,                     /* -ftree-slsr */
  OPT_ftree_sra = 1911,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1912, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1913, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1914,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1915,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1916,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1917, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1918,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1919, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1920,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1921,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1922,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1923,         /* -funconstrained-commons */
  OPT_funderscoring = 1924,                  /* -funderscoring */
  OPT_funit_at_a_time = 1925,                /* -funit-at-a-time */
  OPT_funittest = 1926,                      /* -funittest */
  OPT_funreachable_traps = 1927,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1928,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1929,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1930,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1931, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1932,     /* -funsafe-math-optimizations */
  OPT_funsigned = 1933,                      /* -funsigned */
  OPT_funsigned_bitfields = 1934,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1935,                 /* -funsigned-char */
  OPT_funswitch_loops = 1936,                /* -funswitch-loops */
  OPT_funwind_tables = 1937,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1938,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1939,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1940,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1941,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1942,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1943,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1944,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1945,                     /* -fuse-list= */
  OPT_fvar_tracking = 1946,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1947,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1948,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1949,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1950,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1951, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1952,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1953,                   /* -fverbose-asm */
  /* OPT_fversion = 1954, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1955,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1956,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1957,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1958,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1959,                   /* -fvisibility= */
  OPT_fvpt = 1960,                           /* -fvpt */
  OPT_fvtable_gc = 1961,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1962,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1963,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1964,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1965,                     /* -fvtv-debug */
  OPT_fweak = 1966,                          /* -fweak */
  OPT_fweak_templates = 1967,                /* -fweak-templates */
  OPT_fweb = 1968,                           /* -fweb */
  /* OPT_fwhole_file = 1969, */              /* -fwhole-file */
  OPT_fwhole_program = 1970,                 /* -fwhole-program */
  OPT_fwholediv = 1971,                      /* -fwholediv */
  OPT_fwholevalue = 1972,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1973,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1974,             /* -fworking-directory */
  OPT_fwpa = 1975,                           /* -fwpa */
  OPT_fwpa_ = 1976,                          /* -fwpa= */
  OPT_fwrapv = 1977,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1978,                 /* -fwrapv-pointer */
  OPT_fxref = 1979,                          /* -fxref */
  OPT_fyacc_debug = 1980,                    /* -fyacc-debug */
  /* OPT_fzee = 1981, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1982,          /* -fzero-call-used-regs= */
  OPT_fzero_init_padding_bits_ = 1983,       /* -fzero-init-padding-bits= */
  OPT_fzero_initialized_in_bss = 1984,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1985,                     /* -fzero-link */
  OPT_g = 1986,                              /* -g */
  OPT_gant = 1987,                           /* -gant */
  OPT_gas_loc_support = 1988,                /* -gas-loc-support */
  OPT_gas_locview_support = 1989,            /* -gas-locview-support */
  OPT_gbtf = 1990,                           /* -gbtf */
  OPT_gcodeview = 1991,                      /* -gcodeview */
  OPT_gcoff = 1992,                          /* -gcoff */
  OPT_gcoff1 = 1993,                         /* -gcoff1 */
  OPT_gcoff2 = 1994,                         /* -gcoff2 */
  OPT_gcoff3 = 1995,                         /* -gcoff3 */
  OPT_gcolumn_info = 1996,                   /* -gcolumn-info */
  OPT_gctf = 1997,                           /* -gctf */
  OPT_gdescribe_dies = 1998,                 /* -gdescribe-dies */
  OPT_gdwarf = 1999,                         /* -gdwarf */
  OPT_gdwarf_ = 2000,                        /* -gdwarf- */
  OPT_gdwarf32 = 2001,                       /* -gdwarf32 */
  OPT_gdwarf64 = 2002,                       /* -gdwarf64 */
  OPT_gen_decls = 2003,                      /* -gen-decls */
  OPT_ggdb = 2004,                           /* -ggdb */
  OPT_ggnu_pubnames = 2005,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 2006,                   /* -gimple-stats */
  OPT_ginline_points = 2007,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 2008, /* -ginternal-reset-location-views */
  OPT_gnat = 2009,                           /* -gnat */
  OPT_gnatO = 2010,                          /* -gnatO */
  OPT_gno_ = 2011,                           /* -gno- */
  OPT_gno_pubnames = 2012,                   /* -gno-pubnames */
  OPT_gprune_btf = 2013,                     /* -gprune-btf */
  OPT_gpubnames = 2014,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 2015,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 2016,                   /* -gsplit-dwarf */
  OPT_gstabs = 2017,                         /* -gstabs */
  OPT_gstabs_ = 2018,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 2019,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 2020,                  /* -gstrict-dwarf */
  OPT_gtoggle = 2021,                        /* -gtoggle */
  OPT_gvariable_location_views = 2022,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 2023,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 2024,                           /* -gvms */
  OPT_gxcoff = 2025,                         /* -gxcoff */
  OPT_gxcoff_ = 2026,                        /* -gxcoff+ */
  OPT_gz = 2027,                             /* -gz */
  OPT_gz_ = 2028,                            /* -gz= */
  OPT_h = 2029,                              /* -h */
  OPT_help = 2030,                           /* -help */
  OPT_idirafter = 2031,                      /* -idirafter */
  OPT_imacros = 2032,                        /* -imacros */
  OPT_imultiarch = 2033,                     /* -imultiarch */
  OPT_imultilib = 2034,                      /* -imultilib */
  OPT_include = 2035,                        /* -include */
  OPT_iplugindir_ = 2036,                    /* -iplugindir= */
  OPT_iprefix = 2037,                        /* -iprefix */
  OPT_iquote = 2038,                         /* -iquote */
  OPT_isysroot = 2039,                       /* -isysroot */
  OPT_isystem = 2040,                        /* -isystem */
  OPT_iwithprefix = 2041,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 2042,              /* -iwithprefixbefore */
  OPT_k8 = 2043,                             /* -k8 */
  OPT_l = 2044,                              /* -l */
  OPT_lang_asm = 2045,                       /* -lang-asm */
  OPT_list = 2046,                           /* -list */
  OPT_m32 = 2047,                            /* -m32 */
  OPT_m64 = 2048,                            /* -m64 */
  OPT_mabi_altivec = 2049,                   /* -mabi=altivec */
  OPT_mabi_d32 = 2050,                       /* -mabi=d32 */
  OPT_mabi_d64 = 2051,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 2052,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 2053,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 2054,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 2055,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 2056,                /* -mabi=no-altivec */
  OPT_mabi_vec_default = 2057,               /* -mabi=vec-default */
  OPT_mabi_vec_extabi = 2058,                /* -mabi=vec-extabi */
  OPT_mads = 2059,                           /* -mads */
  OPT_main = 2060,                           /* -main */
  OPT_main_ = 2061,                          /* -main= */
  OPT_maix_struct_return = 2062,             /* -maix-struct-return */
  OPT_malign_ = 2063,                        /* -malign- */
  OPT_malign_branch_targets = 2064,          /* -malign-branch-targets */
  OPT_mallow_movmisalign = 2065,             /* -mallow-movmisalign */
  OPT_maltivec = 2066,                       /* -maltivec */
  OPT_malways_hint = 2067,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 2068,       /* -mavoid-indexed-addresses */
  OPT_mbig = 2069,                           /* -mbig */
  OPT_mbig_endian = 2070,                    /* -mbig-endian */
  OPT_mbit_align = 2071,                     /* -mbit-align */
  OPT_mbit_word = 2072,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 2073,   /* -mblock-compare-inline-limit= */
  OPT_mblock_compare_inline_loop_limit_ = 2074,/* -mblock-compare-inline-loop-limit= */
  OPT_mblock_move_inline_limit_ = 2075,      /* -mblock-move-inline-limit= */
  OPT_mblock_ops_unaligned_vsx = 2076,       /* -mblock-ops-unaligned-vsx */
  OPT_mblock_ops_vector_pair = 2077,         /* -mblock-ops-vector-pair */
  OPT_mbss_plt = 2078,                       /* -mbss-plt */
  OPT_mcall_ = 2079,                         /* -mcall- */
  OPT_mcmpb = 2080,                          /* -mcmpb */
  OPT_mcompat_align_parm = 2081,             /* -mcompat-align-parm */
  OPT_mcpu_ = 2082,                          /* -mcpu= */
  OPT_mcrypto = 2083,                        /* -mcrypto */
  OPT_mdebug_ = 2084,                        /* -mdebug= */
  OPT_mdirect_move = 2085,                   /* -mdirect-move */
  OPT_mdlmzb = 2086,                         /* -mdlmzb */
  OPT_meabi = 2087,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 2088,       /* -mefficient-unaligned-vsx */
  OPT_memb = 2089,                           /* -memb */
  OPT_mfloat128 = 2090,                      /* -mfloat128 */
  OPT_mfloat128_convert = 2091,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 2092,             /* -mfloat128-hardware */
  OPT_mfp_in_toc = 2093,                     /* -mfp-in-toc */
  OPT_mfprnd = 2094,                         /* -mfprnd */
  OPT_mfriz = 2095,                          /* -mfriz */
  OPT_mfull_toc = 2096,                      /* -mfull-toc */
  /* OPT_mfused_madd = 2097, */              /* -mfused-madd */
  OPT_mgcbios = 2098,                        /* -mgcbios */
  OPT_mgcn = 2099,                           /* -mgcn */
  /* OPT_mgen_cell_microcode = 2100, */      /* -mgen-cell-microcode */
  OPT_mgnu_attribute = 2101,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 2102,                      /* -mhard-dfp */
  OPT_mhard_float = 2103,                    /* -mhard-float */
  OPT_mhtm = 2104,                           /* -mhtm */
  OPT_mieee128_constant = 2105,              /* -mieee128-constant */
  OPT_minsert_sched_nops_ = 2106,            /* -minsert-sched-nops= */
  OPT_misel = 2107,                          /* -misel */
  OPT_mlittle = 2108,                        /* -mlittle */
  OPT_mlittle_endian = 2109,                 /* -mlittle-endian */
  OPT_mlong_double_ = 2110,                  /* -mlong-double- */
  OPT_mlongcall = 2111,                      /* -mlongcall */
  /* OPT_mlra = 2112, */                     /* -mlra */
  OPT_mmfcrf = 2113,                         /* -mmfcrf */
  OPT_mmfpgpr = 2114,                        /* -mmfpgpr */
  OPT_mminimal_toc = 2115,                   /* -mminimal-toc */
  OPT_mmma = 2116,                           /* -mmma */
  OPT_mmodulo = 2117,                        /* -mmodulo */
  OPT_mmulhw = 2118,                         /* -mmulhw */
  OPT_mmultiple = 2119,                      /* -mmultiple */
  OPT_mmvme = 2120,                          /* -mmvme */
  OPT_mnewlib = 2121,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 2122,                  /* -mno-fp-in-toc */
  /* OPT_mno_mfpgpr = 2123, */               /* -mno-mfpgpr */
  /* OPT_mno_string = 2124, */               /* -mno-string */
  OPT_mno_sum_in_toc = 2125,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 2126,                        /* -mno-toc */
  OPT_mno_traceback = 2127,                  /* -mno-traceback */
  OPT_mno_update = 2128,                     /* -mno-update */
  OPT_mogc = 2129,                           /* -mogc */
  OPT_moptimize_swaps = 2130,                /* -moptimize-swaps */
  OPT_mpcrel = 2131,                         /* -mpcrel */
  OPT_mpcrel_opt = 2132,                     /* -mpcrel-opt */
  OPT_mpltseq = 2133,                        /* -mpltseq */
  OPT_mpointers_to_nested_functions = 2134,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 2135,                       /* -mpopcntb */
  OPT_mpopcntd = 2136,                       /* -mpopcntd */
  OPT_mpower10 = 2137,                       /* -mpower10 */
  OPT_mpower10_fusion = 2138,                /* -mpower10-fusion */
  OPT_mpower11 = 2139,                       /* -mpower11 */
  OPT_mpower8_fusion = 2140,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 2141,            /* -mpower8-fusion-sign */
  OPT_mpower8_internal = 2142,               /* -mpower8-internal */
  OPT_mpower8_vector = 2143,                 /* -mpower8-vector */
  OPT_mpower9_minmax = 2144,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 2145,                   /* -mpower9-misc */
  OPT_mpower9_vector = 2146,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 2147, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 2148,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 2149,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 2150,                     /* -mpowerpc64 */
  OPT_mprefixed = 2151,                      /* -mprefixed */
  OPT_mprioritize_restricted_insns_ = 2152,  /* -mprioritize-restricted-insns= */
  OPT_mprivileged = 2153,                    /* -mprivileged */
  OPT_mprototype = 2154,                     /* -mprototype */
  OPT_mquad_memory = 2155,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 2156,            /* -mquad-memory-atomic */
  OPT_mreadonly_in_sdata = 2157,             /* -mreadonly-in-sdata */
  OPT_mrecip = 2158,                         /* -mrecip */
  OPT_mrecip_precision = 2159,               /* -mrecip-precision */
  OPT_mrecip_ = 2160,                        /* -mrecip= */
  OPT_mregnames = 2161,                      /* -mregnames */
  OPT_mrelative_jumptables = 2162,           /* -mrelative-jumptables */
  OPT_mrelocatable = 2163,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 2164,               /* -mrelocatable-lib */
  OPT_mrop_protect = 2165,                   /* -mrop-protect */
  OPT_mrvl = 2166,                           /* -mrvl */
  OPT_msave_toc_indirect = 2167,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 2168,             /* -msched-costly-dep= */
  OPT_msched_epilog = 2169,                  /* -msched-epilog */
  OPT_msched_groups = 2170,                  /* -msched-groups */
  OPT_msched_prolog = 2171,                  /* -msched-prolog */
  OPT_msdata = 2172,                         /* -msdata */
  OPT_msdata_ = 2173,                        /* -msdata= */
  OPT_msecure_plt = 2174,                    /* -msecure-plt */
  OPT_mshlib = 2175,                         /* -mshlib */
  OPT_msim = 2176,                           /* -msim */
  OPT_msingle_pic_base = 2177,               /* -msingle-pic-base */
  OPT_msoft_float = 2178,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 2179,      /* -mspeculate-indirect-jumps */
  OPT_msplat_float_constant = 2180,          /* -msplat-float-constant */
  OPT_msplat_word_constant = 2181,           /* -msplat-word-constant */
  OPT_msplit_patch_nops = 2182,              /* -msplit-patch-nops */
  OPT_mstack_protector_guard_offset_ = 2183, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2184,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2185,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2186,                  /* -mstrict-align */
  OPT_mstring = 2187,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 2188,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 2189,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 2190,            /* -msvr4-struct-return */
  OPT_mtls_size_ = 2191,                     /* -mtls-size= */
  OPT_mtoc = 2192,                           /* -mtoc */
  OPT_mtraceback_ = 2193,                    /* -mtraceback= */
  OPT_mtune_ = 2194,                         /* -mtune= */
  OPT_munroll_only_small_loops = 2195,       /* -munroll-only-small-loops */
  OPT_mupdate = 2196,                        /* -mupdate */
  OPT_mveclibabi_ = 2197,                    /* -mveclibabi= */
  OPT_mvgc = 2198,                           /* -mvgc */
  OPT_mvrsave = 2199,                        /* -mvrsave */
  /* OPT_mvrsave_no = 2200, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 2201, */              /* -mvrsave=yes */
  OPT_mvsx = 2202,                           /* -mvsx */
  OPT_mvsx_align_128 = 2203,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 2204, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 2205,             /* -mwarn-altivec-long */
  OPT_mxl_compat = 2206,                     /* -mxl-compat */
  OPT_myellowknife = 2207,                   /* -myellowknife */
  OPT_n = 2208,                              /* -n */
  OPT_name_sort = 2209,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2210,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2211,              /* -no-integrated-cpp */
  OPT_no_pie = 2212,                         /* -no-pie */
  OPT_nocpp = 2213,                          /* -nocpp */
  OPT_nodefaultlibs = 2214,                  /* -nodefaultlibs */
  OPT_nolibc = 2215,                         /* -nolibc */
  OPT_nomain = 2216,                         /* -nomain */
  OPT_nophoboslib = 2217,                    /* -nophoboslib */
  OPT_nostartfiles = 2218,                   /* -nostartfiles */
  OPT_nostdinc = 2219,                       /* -nostdinc */
  OPT_nostdinc__ = 2220,                     /* -nostdinc++ */
  OPT_nostdlib = 2221,                       /* -nostdlib */
  OPT_nostdlib__ = 2222,                     /* -nostdlib++ */
  OPT_o = 2223,                              /* -o */
  OPT_objects = 2224,                        /* -objects */
  OPT_p = 2225,                              /* -p */
  OPT_pass_exit_codes = 2226,                /* -pass-exit-codes */
  /* OPT_pedantic = 2227, */                 /* -pedantic */
  OPT_pedantic_errors = 2228,                /* -pedantic-errors */
  OPT_pg = 2229,                             /* -pg */
  OPT_pie = 2230,                            /* -pie */
  OPT_pipe = 2231,                           /* -pipe */
  OPT_preprocess = 2232,                     /* -preprocess */
  OPT_print_file_name_ = 2233,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2234,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2235,          /* -print-multi-directory */
  OPT_print_multi_lib = 2236,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2237,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2238,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2239,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2240,               /* -print-prog-name= */
  OPT_print_search_dirs = 2241,              /* -print-search-dirs */
  OPT_print_sysroot = 2242,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2243,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2244,                    /* -print-value */
  OPT_quiet = 2245,                          /* -quiet */
  OPT_r = 2246,                              /* -r */
  OPT_remap = 2247,                          /* -remap */
  OPT_reverse_sort = 2248,                   /* -reverse-sort */
  OPT_s = 2249,                              /* -s */
  OPT_save_temps = 2250,                     /* -save-temps */
  OPT_save_temps_ = 2251,                    /* -save-temps= */
  OPT_shared = 2252,                         /* -shared */
  OPT_shared_libgcc = 2253,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2254,               /* -shared-libphobos */
  OPT_size_sort = 2255,                      /* -size-sort */
  /* OPT_specs = 2256, */                    /* -specs */
  OPT_specs_ = 2257,                         /* -specs= */
  OPT_static = 2258,                         /* -static */
  OPT_static_libasan = 2259,                 /* -static-libasan */
  OPT_static_libgcc = 2260,                  /* -static-libgcc */
  OPT_static_libgcobol = 2261,               /* -static-libgcobol */
  OPT_static_libgfortran = 2262,             /* -static-libgfortran */
  OPT_static_libgm2 = 2263,                  /* -static-libgm2 */
  OPT_static_libgo = 2264,                   /* -static-libgo */
  OPT_static_libhwasan = 2265,               /* -static-libhwasan */
  OPT_static_liblsan = 2266,                 /* -static-liblsan */
  OPT_static_libmpx = 2267,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2268,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2269,               /* -static-libphobos */
  OPT_static_libquadmath = 2270,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2271,               /* -static-libstdc++ */
  OPT_static_libtsan = 2272,                 /* -static-libtsan */
  OPT_static_libubsan = 2273,                /* -static-libubsan */
  OPT_static_pie = 2274,                     /* -static-pie */
  /* OPT_std_c__03 = 2275, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2276, */                /* -std=c++0x */
  OPT_std_c__11 = 2277,                      /* -std=c++11 */
  OPT_std_c__14 = 2278,                      /* -std=c++14 */
  OPT_std_c__17 = 2279,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2280, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2281, */                /* -std=c++1z */
  OPT_std_c__20 = 2282,                      /* -std=c++20 */
  OPT_std_c__23 = 2283,                      /* -std=c++23 */
  OPT_std_c__26 = 2284,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2285, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2286, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2287, */                /* -std=c++2c */
  OPT_std_c__98 = 2288,                      /* -std=c++98 */
  OPT_std_c11 = 2289,                        /* -std=c11 */
  OPT_std_c17 = 2290,                        /* -std=c17 */
  /* OPT_std_c18 = 2291, */                  /* -std=c18 */
  /* OPT_std_c1x = 2292, */                  /* -std=c1x */
  OPT_std_c23 = 2293,                        /* -std=c23 */
  /* OPT_std_c2x = 2294, */                  /* -std=c2x */
  OPT_std_c2y = 2295,                        /* -std=c2y */
  /* OPT_std_c89 = 2296, */                  /* -std=c89 */
  OPT_std_c90 = 2297,                        /* -std=c90 */
  OPT_std_c99 = 2298,                        /* -std=c99 */
  /* OPT_std_c9x = 2299, */                  /* -std=c9x */
  OPT_std_f2003 = 2300,                      /* -std=f2003 */
  OPT_std_f2008 = 2301,                      /* -std=f2008 */
  OPT_std_f2008ts = 2302,                    /* -std=f2008ts */
  OPT_std_f2018 = 2303,                      /* -std=f2018 */
  OPT_std_f2023 = 2304,                      /* -std=f2023 */
  OPT_std_f202y = 2305,                      /* -std=f202y */
  OPT_std_f95 = 2306,                        /* -std=f95 */
  OPT_std_gnu = 2307,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2308, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2309, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2310,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2311,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2312,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2313, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2314, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2315,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2316,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2317,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2318, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2319, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2320, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2321,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2322,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2323,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2324, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2325, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2326,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2327, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2328,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2329, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2330,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2331,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2332, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2333, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2334,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2335, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2336, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2337, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2338, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2339, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2340, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2341,                     /* -std=legacy */
  OPT_stdlib_ = 2342,                        /* -stdlib= */
  OPT_symbol_ = 2343,                        /* -symbol= */
  OPT_symbolic = 2344,                       /* -symbolic */
  OPT_t = 2345,                              /* -t */
  OPT_time = 2346,                           /* -time */
  OPT_time_ = 2347,                          /* -time= */
  OPT_traditional = 2348,                    /* -traditional */
  OPT_traditional_cpp = 2349,                /* -traditional-cpp */
  OPT_tree_stats = 2350,                     /* -tree-stats */
  OPT_trigraphs = 2351,                      /* -trigraphs */
  OPT_truncate = 2352,                       /* -truncate */
  OPT_type_stats = 2353,                     /* -type-stats */
  OPT_u = 2354,                              /* -u */
  OPT_undef = 2355,                          /* -undef */
  OPT_v = 2356,                              /* -v */
  OPT_version = 2357,                        /* -version */
  OPT_w = 2358,                              /* -w */
  OPT_wrapper = 2359,                        /* -wrapper */
  OPT_x = 2360,                              /* -x */
  OPT_z = 2361,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
