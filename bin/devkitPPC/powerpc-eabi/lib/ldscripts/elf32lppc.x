...
ENTRY(_start)
SEARCH_DIR("/home/davem/projects/devkitpro/tool-packages/devkitPPC/src/build/x86_64-linux-gnu/devkitPPC/powerpcle-eabi/lib32le"); SEARCH_DIR("/home/davem/projects/devkitpro/tool-packages/devkitPPC/src/build/x86_64-linux-gnu/devkitPPC/powerpcle-eabi/lib");
PROVIDE (__stack = 0); PROVIDE (___stack = 0);
SECTIONS
{
  /* Read-only sections, merged into text segment: */
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x01800000));
  . = SEGMENT_START("text-segment", 0x01800000) + SIZEOF_HEADERS;
